...
const bedsheet=[
    ...
    var objbedsheet={type:"Bedsheet",category:"Bedroom",customer_review:[]}

    var resbedsheet=bedsheet.map((el)=>{

        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objbedsheet,...soldoutobj}
    })

 Bedsheet.insertMany({
     name:"bedsheet",
     type:"Bedroom",
     products:resbedsheet
 },()=>{
     console.log("Bedsheet inserted into Atlas !")
 })
 ...
 const quilt=[
    ...
    var resquilt=quilt.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objquilt,...soldoutobj}
    })
 ...
 Quilt.insertMany({
    ...
    console.log("quilt inserted into Atlas !")
})
...
const pillow_cover=[
    ...
    var respillow=pillow_cover.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objpillow,...soldoutobj}
    })

Pillowcover.insertMany({
    name:"pillowcover",
    type:"Bedroom",
    products:respillow
},()=>{
    console.log("pillowcover inserted into Atlas !")
})
...
const comforter_set=[
    ...
    var rescomfort=comforter_set.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objcomforter,...soldoutobj}
    })

Comforterset.insertMany({
    name:"comforterset",
    type:"Bedroom",
    products:rescomfort
},()=>{
    console.log("comforterset inserted into Atlas !")
})
...
const sofa_cover=[
    ...
    var ressofa=sofa_cover.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objsofa,...soldoutobj}
    })
...
Sofa.insertMany({
    ...
    console.log("sofacover inserted into Atlas !")
})
...
const window_curtain=[
    ...
    var objwindow={type:"Windowcurtain",category:"Livingroom",    customer_review:[]
}

    var reswindow=window_curtain.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objwindow,...soldoutobj}
    })

Windowcurtain.insertMany({
    name:"windowcurtain",
    type:"Living-room",
    products:reswindow
},()=>{
    console.log("windowcurtain inserted into Atlas !")
})
...
const rugs=[
    ...
    var resrug=rugs.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objrug,...soldoutobj}
    })
...
Rugs.insertMany({
    ...
    console.log("rugs inserted into Atlas !")
})
...
const kitchen_towel=[
    ...
    var resktowel=kitchen_towel.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objktowel,...soldoutobj}
    })
...
Kitchen.insertMany({
    ...
    console.log("k.towel inserted into Atlas !")
})
...
const apron=[
    ...
    var objapron={type:"Apron",category:"Livingroom",    customer_review:[]
}

    var resapron=apron.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objapron,...soldoutobj}
    })
...
Apron.insertMany({
    ...
    console.log("apron inserted into Atlas !")
})
...
const placemat=[
    ...
    var resplacemat=placemat.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objplacemat,...soldoutobj}
    })

Placemat.insertMany({
    name:"placemat",
    type:"Table-linen",
    products:resplacemat
},()=>{
    console.log("placemat inserted into Atlas !")
})
...
const table_clothe=[
    ...
    var restcloth=table_clothe.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objtcloth,...soldoutobj}
    })
    
Tableclothe.insertMany({
    name:"tablecloth",
    type:"Table-linen",
    products:restcloth
},()=>{
    console.log("table clothe inserted into Atlas !")
})
...
const table_runner=[
    ...
    var restrunner=table_runner.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objtrunner,...soldoutobj}
    })

Tablerunner.insertMany({
    name:"tablerunner",
    type:"Table-linen",
    products:restrunner
},()=>{
    console.log(" table runner inserted into Atlas !")
})
...
const napkin=[
    ...
    var resnapkin=napkin.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objnapkin,...soldoutobj}
    })
...
Napkin.insertMany({
    ...
    console.log("napkin inserted into Atlas !")
})
...
const bathroom_mat=[
    ...
    var resbmat=bathroom_mat.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objbmat,...soldoutobj}
    })
...
Bathmat.insertMany({
    ...
    console.log("bathmat inserted into Atlas !")
})
...
const s_curtain=[
    ...
    var resscurtain=s_curtain.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objscurtain,...soldoutobj}
    })

Showercurtain.insertMany({
    name:"showercurtain",
    type:"Bathroom",
    products:resscurtain
},()=>{
    console.log("s.curtain inserted into Atlas !")
})
...
const bath_towel=[
    ...
    var resbtowel=bath_towel.map((el)=>{
        var soldoutobj={soldout:Math.floor((500-50) * Math.random()+50)}
        return arr={...el,...objbtowel,...soldoutobj}
    })
       

Bathtowel.insertMany({
    name:"bathtowel",
    type:"Bathroom",
    products:resbtowel
},()=>{
    console.log("bathtowel inserted into Atlas !")
})
